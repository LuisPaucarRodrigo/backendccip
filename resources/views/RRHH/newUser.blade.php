...
@section('content')
    <div class="container">
        <form action="/rrhh/createuser" enctype="multipart/form-data" method="post" class="row g-3">
            @csrf
            <div class="col-md-6">
            ...
            <input class="form-control" type="hidden" name="saldo"  value="0.00" placeholder="0.00">
