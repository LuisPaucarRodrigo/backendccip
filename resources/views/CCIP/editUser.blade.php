...
@section('content')
    <div class="container">
        <form action="/home/update/{{$usuario->id}}" enctype="multipart/form-data" method="post">
            @csrf
            <div class="mb-3">
            ...
            <div class="row">
                <div class="col">
                    <a class="btn btn-success" href="/home/edit/password/{{$usuario->id}}">Cambiar Contraseña</a>
                </div>
